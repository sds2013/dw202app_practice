...
public class Ex25SQLiteExJoin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_ex25_sqlite_join);

        //데이베이스 생성.
        helper = new MySQLiteOpenHelper(
                Ex25SQLiteExJoin.this, // 현재 화면의 context
                "member2.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnJoin:
                    ...
                    {
                        Toast.makeText(Ex25SQLiteExJoin.this, "아이디를 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    ...
                    {
                        Toast.makeText(Ex25SQLiteExJoin.this, "비번을 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    //공백없이 입력잘되었을경우 변수에 저장
                    ...
                    {
                        Toast.makeText(Ex25SQLiteExJoin.this, "이름을 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    //공백없이 입력잘되었을경우 변수에 저장
                    ...
                    {
                        Toast.makeText(Ex25SQLiteExJoin.this, "연락처를 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    ...
                    {
                        Toast.makeText(Ex25SQLiteExJoin.this, "주소를 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    ...
                    //회원가입 후 저장정보 확1인하기.
                    Intent intentJoinOk = new Intent(Ex25SQLiteExJoin.this, Ex25JoinOkActivity.class);
