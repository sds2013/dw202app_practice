        ...
        public void onClick(View v)
        {
            switch(v.getId())
            {
                case R.id.btnTel1:
                    ...
                    Toast.makeText(Ex10PhoneCreate1Ex.this,tel_name1+"에게 전화를 겁니다!",Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btnTel2:
                    ...
                    Toast.makeText(Ex10PhoneCreate1Ex.this,tel_name2+"에게 전화를 겁니다!",Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btnTel3:
                    ...
                    Toast.makeText(Ex10PhoneCreate1Ex.this,tel_name3+"에게 전화를 겁니다!",Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btnTel4:
                    ...
                    Toast.makeText(Ex10PhoneCreate1Ex.this,tel_name4+"에게 전화를 겁니다!",Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btnTel5:
                    ...
                    Toast.makeText(Ex10PhoneCreate1Ex.this,tel_name5+"에게 전화를 겁니다!",Toast.LENGTH_SHORT).show();
                    break;
